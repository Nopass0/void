...
Values are stored as strings; JSON payloads should be stringified by the client.
...
These endpoints use Server-Sent Events.
...
- For destructive actions, require explicit user confirmation in higher-level tooling.
